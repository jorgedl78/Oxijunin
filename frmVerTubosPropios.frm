...
Begin VB.Form frmVerTubosPropios 
   Caption         =   "Tubos Propios"
   ClientHeight    =   8355
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11355
   ...
   Begin VB.CommandButton cmdSalir 
      ...
      Height          =   855
      Left            =   5040
      Picture         =   "frmVerTubosPropios.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   7320
      Width           =   1095
   End
End
Attribute VB_Name = "frmVerTubosPropios"
